...
func registerSDKWords(r *eng.Registry, client *sdk.StrictlyBetterSDK) {
...
func runOp(client *sdk.StrictlyBetterSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
