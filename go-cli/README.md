...
AQL-driven CLI and REPL for the StrictlyBetter SDK. Positional arguments are
...
```sh
go build -o strictly-better-cli ./...
```
...
./strictly-better-cli load 1 functional_reprint
./strictly-better-cli load '{id:1}' functional_reprint
