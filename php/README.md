...
The PHP SDK for the StrictlyBetter API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->FunctionalReprint(null)->list(null, null);
...
[$result, $err] = $client->StrictlyBetter(null)->load(
    ["id" => "test01"], null
);
