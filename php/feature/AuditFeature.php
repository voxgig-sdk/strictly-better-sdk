...
// StrictlyBetter SDK audit feature
...
class StrictlyBetterAuditFeature extends StrictlyBetterBaseFeature
{
    ...
    private function _emit(StrictlyBetterContext $ctx, string $outcome): void
    {
