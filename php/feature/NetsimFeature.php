...
// StrictlyBetter SDK netsim feature
...
class StrictlyBetterNetsimFeature extends StrictlyBetterBaseFeature
{
    ...
    private function _simulate(StrictlyBetterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(StrictlyBetterContext $ctx, array $applied): void
    {
        $client = $this->client;
