...
// StrictlyBetter SDK ratelimit feature
...
class StrictlyBetterRatelimitFeature extends StrictlyBetterBaseFeature
{
    ...
    private function _acquire(StrictlyBetterContext $ctx): void
    {
    ...
    private function _track(StrictlyBetterContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
