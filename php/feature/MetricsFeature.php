...
// StrictlyBetter SDK metrics feature
...
class StrictlyBetterMetricsFeature extends StrictlyBetterBaseFeature
{
    ...
    private function _record(StrictlyBetterContext $ctx, bool $ok): void
    {
