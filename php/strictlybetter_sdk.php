...
class StrictlyBetterSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = StrictlyBetterHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = StrictlyBetterHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!StrictlyBetterFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, StrictlyBetterFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return StrictlyBetterUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = StrictlyBetterHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = StrictlyBetterHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = StrictlyBetterHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new StrictlyBetterError($op . "_allow",
                "StrictlyBetterSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = StrictlyBetterHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new StrictlyBetterError("graphql_error",
                "StrictlyBetterSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function FunctionalReprint($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_functional_reprint === null) {
                $this->_functional_reprint = new FunctionalReprintEntity($this, null);
            }
            return $this->_functional_reprint;
        }
    ...
    public function Obsolete($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_obsolete === null) {
                $this->_obsolete = new ObsoleteEntity($this, null);
            }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new StrictlyBetterSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
