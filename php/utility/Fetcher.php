...
// StrictlyBetter SDK utility: fetcher

class StrictlyBetterFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; StrictlyBetterSDK/1.0)';
    ...
    public static function call(StrictlyBetterContext $ctx, string $fullurl, array $fetchdef): array
    {
