...
// StrictlyBetter SDK utility: graphql
//
...
class StrictlyBetterGraphql
{
    ...
    // equivalent.
    public static function body(StrictlyBetterContext $ctx): mixed
    {
    ...
    public static function errors(StrictlyBetterContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
