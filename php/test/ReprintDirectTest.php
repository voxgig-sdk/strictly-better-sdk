...
class ReprintDirectTest extends TestCase
{
    public function test_direct_list_reprint(): void
    {
        $setup = reprint_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-reprint", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
