...
// StrictlyBetter SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (StrictlyBetterSDK::test)
...
{
    private const SDK_CLASS = 'StrictlyBetterSDK';
    ...
    private const SDK_BASE = 'strictlybetter_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../strictlybetter_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
