...
// StrictlyBetter SDK pipeline test
//
...
{
    private static function utility(): StrictlyBetterUtility
    {
        return new StrictlyBetterUtility();
    }
    ...
    private static function ctx(array $over = []): StrictlyBetterContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new StrictlyBetterContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new StrictlyBetterOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof StrictlyBetterError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new StrictlyBetterOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = StrictlyBetterMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new StrictlyBetterOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = StrictlyBetterMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new StrictlyBetterOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = StrictlyBetterMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new StrictlyBetterSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = StrictlyBetterMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new StrictlyBetterResponse([]),
            'result' => new StrictlyBetterResult([]),
        ]);
        [, $err] = StrictlyBetterMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new StrictlyBetterSpec([]),
            'response' => null,
            'result' => new StrictlyBetterResult([]),
        ]);
        [, $err] = StrictlyBetterMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new StrictlyBetterSpec(['step' => 's']),
            'response' => new StrictlyBetterResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new StrictlyBetterResult([]),
        ]);
        [, $err] = StrictlyBetterMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new StrictlyBetterSpec(['step' => 's']),
            'response' => new StrictlyBetterResponse(self::resp(200, ['v' => 1])),
            'result' => new StrictlyBetterResult([]),
        ]);
        [, $err] = StrictlyBetterMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new StrictlyBetterSpec(['step' => 's']),
            'response' => new StrictlyBetterResponse(self::resp(200, ['v' => 2])),
            'result' => new StrictlyBetterResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        StrictlyBetterMakeResponse::call($ctx);
    ...
    {
        $preset = new StrictlyBetterResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new StrictlyBetterSpec([]),
            'response' => new StrictlyBetterResponse([]),
            'result' => new StrictlyBetterResult([]),
        ...
        [$got, $err] = StrictlyBetterMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new StrictlyBetterResult([])]);
        [, $err] = StrictlyBetterMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new StrictlyBetterSpec([]), 'result' => null]);
        [, $err] = StrictlyBetterMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new StrictlyBetterSpec(['step' => 's']),
            'result' => new StrictlyBetterResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new StrictlyBetterOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = StrictlyBetterMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new StrictlyBetterSpec(['step' => 's']),
            'result' => new StrictlyBetterResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new StrictlyBetterOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = StrictlyBetterMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new StrictlyBetterResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new StrictlyBetterSpec([]),
            'result' => new StrictlyBetterResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = StrictlyBetterMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = StrictlyBetterMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new StrictlyBetterError('boom', 'boom');
        $utility->fetcher = function (StrictlyBetterContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new StrictlyBetterSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = StrictlyBetterMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (StrictlyBetterContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = StrictlyBetterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(StrictlyBetterResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        StrictlyBetterMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (StrictlyBetterContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new StrictlyBetterSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = StrictlyBetterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new StrictlyBetterResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new StrictlyBetterSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = StrictlyBetterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = StrictlyBetterMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = StrictlyBetterMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new StrictlyBetterResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, StrictlyBetterDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new StrictlyBetterResult(['ok' => false])]);
        $this->expectException(StrictlyBetterError::class);
        StrictlyBetterDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new StrictlyBetterResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', StrictlyBetterMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        StrictlyBetterMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new StrictlyBetterBaseFeature();
        $b = new StrictlyBetterBaseFeature();
        StrictlyBetterFeatureAdd::call($ctx, $a);
        StrictlyBetterFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): StrictlyBetterBaseFeature
    {
        $f = new StrictlyBetterBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        StrictlyBetterFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): StrictlyBetterContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new StrictlyBetterSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = StrictlyBetterPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        StrictlyBetterPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new StrictlyBetterResponse(['headers' => null]),
            'result' => new StrictlyBetterResult([]),
        ]);
        StrictlyBetterResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        StrictlyBetterResultBody::call($ctx);
