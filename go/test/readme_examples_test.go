...
const testSeed = `map[string]any{"entity": map[string]any{"functional_reprint": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "obsolete": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
