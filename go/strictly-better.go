...
// instead of `sdk.NewStrictlyBetterSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *StrictlyBetterSDK  { return NewStrictlyBetterSDK(nil) }
func Test() *StrictlyBetterSDK { return TestSDK(nil, nil) }
