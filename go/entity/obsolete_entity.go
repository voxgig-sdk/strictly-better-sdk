...
func NewObsoleteEntity(client *core.StrictlyBetterSDK, entopts map[string]any) *ObsoleteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ObsoleteEntity) GetName() string { return e.name }
...
func (e *ObsoleteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ObsoleteEntity) Deleted() bool {
	return e.deleted
}


func (e *ObsoleteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewObsoleteEntity(e.client, opts)
}

func (e *ObsoleteEntity) Data(args ...any) any {
...
func (e *ObsoleteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Obsolete; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ObsoleteEntity) DataTyped(data ...Obsolete) Obsolete {
	if len(data) > 0 {
		return typedFrom[Obsolete](e.Data(asMap(data[0])))
	}
	return typedFrom[Obsolete](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Obsolete (all fields
// optional at the wire level).
func (e *ObsoleteEntity) MatchTyped(match ...Obsolete) Obsolete {
	if len(match) > 0 {
		return typedFrom[Obsolete](e.Match(asMap(match[0])))
	}
	return typedFrom[Obsolete](e.Match())
}
...
func (e *ObsoleteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ObsoleteEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ObsoleteEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ObsoleteListMatch and returns []Obsolete. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ObsoleteEntity) ListTyped(reqmatch ObsoleteListMatch, ctrl map[string]any) ([]Obsolete, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Obsolete](res), nil
}



func (e *ObsoleteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ObsoleteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ObsoleteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ObsoleteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
