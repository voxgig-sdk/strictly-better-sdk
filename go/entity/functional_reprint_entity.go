...
type FunctionalReprintEntity struct {
	name    string
	client  *core.StrictlyBetterSDK
...
func NewFunctionalReprintEntity(client *core.StrictlyBetterSDK, entopts map[string]any) *FunctionalReprintEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FunctionalReprintEntity) GetName() string { return e.name }
...
func (e *FunctionalReprintEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FunctionalReprintEntity) Deleted() bool {
	return e.deleted
}


func (e *FunctionalReprintEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFunctionalReprintEntity(e.client, opts)
}

func (e *FunctionalReprintEntity) Data(args ...any) any {
...
func (e *FunctionalReprintEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FunctionalReprint; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FunctionalReprintEntity) DataTyped(data ...FunctionalReprint) FunctionalReprint {
	if len(data) > 0 {
		return typedFrom[FunctionalReprint](e.Data(asMap(data[0])))
	}
	return typedFrom[FunctionalReprint](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FunctionalReprint (all fields
// optional at the wire level).
func (e *FunctionalReprintEntity) MatchTyped(match ...FunctionalReprint) FunctionalReprint {
	if len(match) > 0 {
		return typedFrom[FunctionalReprint](e.Match(asMap(match[0])))
	}
	return typedFrom[FunctionalReprint](e.Match())
}
...
func (e *FunctionalReprintEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FunctionalReprintEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *FunctionalReprintEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FunctionalReprintListMatch and returns []FunctionalReprint. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FunctionalReprintEntity) ListTyped(reqmatch FunctionalReprintListMatch, ctrl map[string]any) ([]FunctionalReprint, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[FunctionalReprint](res), nil
}



func (e *FunctionalReprintEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FunctionalReprintEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FunctionalReprintEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FunctionalReprintEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
