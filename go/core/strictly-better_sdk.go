...
func (sdk *StrictlyBetterSDK) OptionsMap() map[string]any {
...
func (sdk *StrictlyBetterSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *StrictlyBetterSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *StrictlyBetterSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *StrictlyBetterSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *StrictlyBetterSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *StrictlyBetterSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("StrictlyBetterSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *StrictlyBetterSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *StrictlyBetterSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("StrictlyBetterSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *StrictlyBetterSDK {
	...
	sdk := NewStrictlyBetterSDK(sdkopts)
	sdk.Mode = "test"
