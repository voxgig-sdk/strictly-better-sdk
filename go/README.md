...
The Golang SDK for the StrictlyBetter API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/strictly-better-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/strictly-better-sdk=../path/to/github.com/voxgig-sdk/strictly-better-sdk
```
...
```
github.com/voxgig-sdk/strictly-better-sdk/
...
The root package (`github.com/voxgig-sdk/strictly-better-sdk`) re-exports everything needed
