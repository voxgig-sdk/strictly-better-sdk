// Command StrictlyBetter-mcp is an MCP server exposing the StrictlyBetter
// SDK as MCP tools.
//
// Two tools are registered:
//
//	StrictlyBetter_list  — list records of an entity
//	StrictlyBetter_load  — load a single record of an entity
//
