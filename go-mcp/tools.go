...
type Args struct {
	Entity string         `json:"entity" jsonschema:"functional_reprint | obsolete"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.StrictlyBetterSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "strictly-better_list",
		Description: "List records from StrictlyBetter. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "strictly-better_load",
		Description: "Load a single record from StrictlyBetter. " +
...
func runOp(client *sdk.StrictlyBetterSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
