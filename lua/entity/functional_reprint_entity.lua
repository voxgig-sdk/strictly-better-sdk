...
local FunctionalReprintEntity = {}
FunctionalReprintEntity.__index = FunctionalReprintEntity


function FunctionalReprintEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FunctionalReprintEntity)
  self._name = "functional_reprint"
  self._client = client
...
function FunctionalReprintEntity:get_name()
  return self._name
end


function FunctionalReprintEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FunctionalReprintEntity.new(self._client, opts)
end
...
function FunctionalReprintEntity:mark_deleted()
  self._deleted = true
end


function FunctionalReprintEntity:deleted()
  return true == self._deleted
end


function FunctionalReprintEntity:data_set(args)
  if args ~= nil then
...
function FunctionalReprintEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FunctionalReprintEntity:match_set(args)
  if args ~= nil then
...
function FunctionalReprintEntity:match_get()
...
function FunctionalReprintEntity:stream(action, args, callopts)
...
function FunctionalReprintEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return FunctionalReprintEntity
