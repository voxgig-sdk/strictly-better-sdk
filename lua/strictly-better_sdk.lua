...
local StrictlyBetterSDK = {}
StrictlyBetterSDK.__index = StrictlyBetterSDK
...
StrictlyBetterSDK._make_feature = _make_feature


function StrictlyBetterSDK.new(options)
  local self = setmetatable({}, StrictlyBetterSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function StrictlyBetterSDK:options_map()
...
function StrictlyBetterSDK:get_utility()
  return Utility.copy(self._utility)
end


function StrictlyBetterSDK:get_root_ctx()
  return self._rootctx
end


function StrictlyBetterSDK:prepare(fetchargs)
...
function StrictlyBetterSDK:direct(fetchargs)
...
-- by passing it.
function StrictlyBetterSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function StrictlyBetterSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "StrictlyBetterSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function StrictlyBetterSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = StrictlyBetterSDK.new(sdkopts)
  sdk.mode = "test"
