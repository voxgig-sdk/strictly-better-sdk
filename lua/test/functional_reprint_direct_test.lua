...
describe("FunctionalReprintDirect", function()
  it("should direct-list-functional_reprint", function()
    local setup = functional_reprint_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-functional_reprint", setup.live and "live" or "unit")
...
function functional_reprint_direct_setup(mockres)
