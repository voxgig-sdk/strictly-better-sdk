...
describe("ObsoleteDirect", function()
  it("should direct-list-obsolete", function()
    local setup = obsolete_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-obsolete", setup.live and "live" or "unit")
