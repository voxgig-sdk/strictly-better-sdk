...
describe("ReprintDirect", function()
  it("should direct-list-reprint", function()
    local setup = reprint_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-reprint", setup.live and "live" or "unit")
...
function reprint_direct_setup(mockres)
