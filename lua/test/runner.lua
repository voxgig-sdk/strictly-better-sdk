...
function runner.env_override(m)
  local live = runner.getenv("STRICTLY_BETTER_TEST_LIVE")
  local override = runner.getenv("STRICTLY_BETTER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("STRICTLY_BETTER_TEST_EXPLAIN")
