...
function runner.env_override(m)
  local live = runner.getenv("STRICTLYBETTER_TEST_LIVE")
  local override = runner.getenv("STRICTLYBETTER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("STRICTLYBETTER_TEST_EXPLAIN")
