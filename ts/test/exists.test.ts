...
describe('exists', async () => {
  ...
  //
  // StrictlyBetterSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof StrictlyBetterSDK, true,
      'StrictlyBetterSDK.test() must return a client synchronously')
  })
