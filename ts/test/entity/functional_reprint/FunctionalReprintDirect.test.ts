...
describe('FunctionalReprintDirect', async () => {
  ...
  test('direct-list-functional_reprint', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-functional_reprint', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['STRICTLY_BETTER_TEST_FUNCTIONAL_REPRINT_ENTID']
