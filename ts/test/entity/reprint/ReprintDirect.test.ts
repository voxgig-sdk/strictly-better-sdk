...
describe('ReprintDirect', async () => {
  ...
  test('direct-list-reprint', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-reprint', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['STRICTLYBETTER_TEST_REPRINT_ENTID']
