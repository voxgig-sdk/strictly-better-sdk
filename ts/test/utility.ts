...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.STRICTLY_BETTER_TEST_LIVE ||
    'TRUE' === process.env.STRICTLY_BETTER_TEST_OVERRIDE
  ) {
  ...
  m.STRICTLY_BETTER_TEST_EXPLAIN = process.env.STRICTLY_BETTER_TEST_EXPLAIN || m.STRICTLY_BETTER_TEST_EXPLAIN
