...
This API allows users to retrieve and search for obsolete cards in JSON format.

Learn more about Strictly Better API at [www.strictlybetter.eu/api-guide](https://www.strictlybetter.eu/api-guide).
...
// functionalreprints is an array of FunctionalReprint entities, populated with mock data
// — call functionalreprints[0].data() for the record itself
...
| Go CLI | `github.com/voxgig-sdk/strictly-better-sdk/go-cli` | `go install github.com/voxgig-sdk/strictly-better-sdk/go-cli/cmd/strictly-better@latest` |
| Go MCP server | `github.com/voxgig-sdk/strictly-better-sdk/go-mcp` | `go get github.com/voxgig-sdk/strictly-better-sdk/go-mcp@latest` |
...
// List all functionalreprints (returns FunctionalReprintEntity[] — .data() for the record)
const functionalreprints = await client.FunctionalReprint().list()
