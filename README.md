...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/strictly-better` | `npm install @voxgig-sdk/strictly-better` |
| Python | `voxgig-sdk-strictly-better` | `pip install voxgig-sdk-strictly-better` |
| PHP | `voxgig-sdk/strictly-better` | `composer require voxgig-sdk/strictly-better` |
| Golang | `github.com/voxgig-sdk/strictly-better-sdk/go` | `go get github.com/voxgig-sdk/strictly-better-sdk/go` |
| Ruby | `voxgig-sdk-strictly-better` | `gem install voxgig-sdk-strictly-better` |
| Lua | `voxgig-sdk-strictly-better` | `luarocks install voxgig-sdk-strictly-better` |
