# StrictlyBetter Python SDK



The Python SDK for the StrictlyBetter API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.FunctionalReprint()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/strictly-better-sdk/releases)) or
...
```
py/
├── strictlybetter_sdk.py         -- Main SDK module
