...
The Python SDK for the StrictlyBetter API. Provides an entity-oriented interface following Pythonic conventions.
...
result, err = client.StrictlyBetter(None).load(
    {"id": "test01"}, None
)
