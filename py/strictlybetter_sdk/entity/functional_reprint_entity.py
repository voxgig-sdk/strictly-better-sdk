...
from strictlybetter_sdk.strictlybetter_types import (
    FunctionalReprint,
...
class FunctionalReprintEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FunctionalReprintEntity(self._client, opts)
    ...
    def data_get(self) -> FunctionalReprint:
    ...
    def match_get(self) -> FunctionalReprint:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[FunctionalReprint]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.FunctionalReprint().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
