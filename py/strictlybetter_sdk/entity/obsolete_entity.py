...
class ObsoleteEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ObsoleteEntity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Obsolete]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Obsolete().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
