...
class StrictlyBetterTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StrictlyBetterTestRunner.getenv("STRICTLYBETTER_TEST_LIVE")
        override = StrictlyBetterTestRunner.getenv("STRICTLYBETTER_TEST_OVERRIDE")
        ...
        explain = StrictlyBetterTestRunner.getenv("STRICTLYBETTER_TEST_EXPLAIN")
