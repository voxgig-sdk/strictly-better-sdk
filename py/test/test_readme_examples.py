# StrictlyBetter SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions StrictlyBetterSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both StrictlyBetterSDK(...) and StrictlyBetterSDK.test(...) become
#      StrictlyBetterSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "strictlybetter_sdk"
_SDK_CLASS = "StrictlyBetterSDK"
...
_ENTITIES = {
    "FunctionalReprint": "functional_reprint",
    "Obsolete": "obsolete",
}
