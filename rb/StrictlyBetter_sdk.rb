...
require_relative 'StrictlyBetter_types'
...
class StrictlyBetterSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = StrictlyBetterHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = StrictlyBetterHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, StrictlyBetterFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    StrictlyBetterUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = StrictlyBetterHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = StrictlyBetterHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = StrictlyBetterHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    rescue StrictlyBetterError => err
    ...
    if fetched.is_a?(Hash)
      status = StrictlyBetterHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = StrictlyBetterError.new(
        "graphql_error", "StrictlyBetterSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = StrictlyBetterSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
