...
class ObsoleteEntity
  ...
  def make
    opts = @_entopts.dup
    ObsoleteEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [ObsoleteListMatch, Hash, nil] match filter (any subset of
  #   Obsolete fields); defaults to nil, treated as an empty match that lists all.
