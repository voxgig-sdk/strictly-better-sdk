...
#      offline in seeded test mode (StrictlyBetterSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "StrictlyBetter_sdk.rb")
  SDK_CLASS = "StrictlyBetterSDK"
