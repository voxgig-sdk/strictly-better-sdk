...
The Ruby SDK for the StrictlyBetter API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.StrictlyBetter(nil).load(
  { "id" => "test01" }, nil
)
