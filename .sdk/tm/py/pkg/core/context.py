...
from projectname_sdk.core.control import StrictlyBetterControl
...
class StrictlyBetterContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = StrictlyBetterControl()
        ...
        if isinstance(sp, StrictlyBetterSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, StrictlyBetterResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, StrictlyBetterResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return StrictlyBetterOperation({})
    ...
    def make_error(self, code, msg):
        return StrictlyBetterError(code, msg, self)
