...
class StrictlyBetterTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StrictlyBetterTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = StrictlyBetterTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = StrictlyBetterTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
