...
class StrictlyBetterTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = StrictlyBetterTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = StrictlyBetterTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = StrictlyBetterTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
