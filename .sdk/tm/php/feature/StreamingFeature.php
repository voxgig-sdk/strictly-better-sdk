...
// StrictlyBetter SDK streaming feature
...
class StrictlyBetterStreamingFeature extends StrictlyBetterBaseFeature
{
    ...
    private function _iterate(StrictlyBetterResult $result): \Generator
    {
    ...
    private function _streamable(StrictlyBetterContext $ctx): bool
    {
