...
// StrictlyBetter SDK rbac feature
...
class StrictlyBetterRbacFeature extends StrictlyBetterBaseFeature
{
    ...
    private function _required(StrictlyBetterContext $ctx): ?string
    {
    ...
    private function _reject(StrictlyBetterContext $ctx, string $required): void
    {
    ...
    private function _track(StrictlyBetterContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
