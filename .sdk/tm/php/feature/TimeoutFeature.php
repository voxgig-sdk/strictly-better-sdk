...
// StrictlyBetter SDK timeout feature
...
class StrictlyBetterTimeoutFeature extends StrictlyBetterBaseFeature
{
    ...
    private function _with_timeout(StrictlyBetterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(StrictlyBetterContext $_ctx, float $ms): void
    {
        $client = $this->client;
