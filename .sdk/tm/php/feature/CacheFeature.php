...
// StrictlyBetter SDK cache feature
...
class StrictlyBetterCacheFeature extends StrictlyBetterBaseFeature
{
    ...
    private function _through(StrictlyBetterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
