...
// StrictlyBetter SDK proxy feature
...
class StrictlyBetterProxyFeature extends StrictlyBetterBaseFeature
{
    ...
    public function init(StrictlyBetterContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (StrictlyBetterContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
