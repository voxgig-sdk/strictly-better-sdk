...
// StrictlyBetter SDK clienttrack feature
...
class StrictlyBetterClienttrackFeature extends StrictlyBetterBaseFeature
{
    ...
    public function PostConstruct(StrictlyBetterContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'StrictlyBetter-SDK';
