...
// StrictlyBetter SDK utility type

class StrictlyBetterUtility
{
    ...
    public static function copy(StrictlyBetterUtility $src): StrictlyBetterUtility
    {
        $u = new StrictlyBetterUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
